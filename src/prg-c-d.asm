...
loc_BANKC_853A:
	LDA #$CF ;[BR] Fix bottom crop that was 1 pixel off
	STA SpriteDMAArea, Y
	INY
	LDA #$3E
	STA SpriteDMAArea, Y
...
; [BR] CAST objects length minus one (original-$0F)
	LDX #$1F
...
loc_BANKC_85EB:
	...
	;[BR] Y position for the new CAST letters
...
CastRoll_SpritePointersLo:
	...
	.db <CastRoll_Clawglip
	.db <CastRoll_Triclyde
; [BR] Every object for the outlined sprites
; had their Y position adjusted to the crop object's Y position
CastRoll_Mario: 
	.db $CF, $3E, $00, $30
	.db $CF, $00, $00, $38 ; 4
	.db $CF, $02, $00, $40 ; 8
...
CastRoll_Pokey:
	...
	.db $F9, $EC, $00, $50 ; $38
	.db $F9, $E6, $00, $58 ; $3C
CastRoll_Birdo: ; This is actually Ostro...
	.db $CF, $3E, $00, $30
	.db $CF, $70, $00, $38 ; 4
	.db $CF, $72, $00, $40 ; 8
	.db $CF, $3E, $00, $48 ; $C
	...
	.db $F9, $CE, $00, $54 ; $38
	.db $F9, $3E, $00, $5C ; $3C
CastRoll_Ostro: ; ...and this is the actual Birdo
	.db $CF, $3E, $00, $30
	.db $CF, $78, $00, $38 ; 4
	.db $CF, $7A, $00, $40 ; 8
	.db $CF, $3E, $00, $48 ; $C
...
CastRoll_Cobrat:
	...
	.db $F9, $D8, $00, $58 ; $3C
CastRoll_Mouser:
	.db $CF, $88, 0, $34 ; Centered outlined sprite
	.db $CF, $8A, $00, $3C ; 4
	.db $CF, $8C, $00, $44 ; 8
	.db $CF, $3E, $00, $4C ; $C
	.db $F9, $8E, $00, $34 ; $10
